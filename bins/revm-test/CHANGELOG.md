...
## [0.1.0](https://github.com/tcoratger/revm/releases/tag/revm-test-v0.1.0) - 2024-08-12
...
### Fixed
- *(eof)* fixture 2 tests ([#1550](https://github.com/tcoratger/revm/pull/1550))
- *(clippy)* fix some clippy lints

### Other
- tag v41 revm v13.0.0 ([#1692](https://github.com/tcoratger/revm/pull/1692))
- release ([#1683](https://github.com/tcoratger/revm/pull/1683))
- *(deps)* bump regex from 1.10.5 to 1.10.6 ([#1682](https://github.com/tcoratger/revm/pull/1682))
- bump versions bcs of primitives ([#1631](https://github.com/tcoratger/revm/pull/1631))
- release ([#1620](https://github.com/tcoratger/revm/pull/1620))
- *(deps)* bump alloy-sol-types from 0.7.6 to 0.7.7 ([#1614](https://github.com/tcoratger/revm/pull/1614))
- *(deps)* bump alloy-sol-macro from 0.7.6 to 0.7.7 ([#1613](https://github.com/tcoratger/revm/pull/1613))
- release ([#1579](https://github.com/tcoratger/revm/pull/1579))
- release ([#1548](https://github.com/tcoratger/revm/pull/1548))
- replace TransactTo with TxKind ([#1542](https://github.com/tcoratger/revm/pull/1542))
