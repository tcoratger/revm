...
## [10.0.0](https://github.com/tcoratger/revm/compare/revm-v9.0.0...revm-v10.0.0) - 2024-06-16

### Added
- mutable access for all fields in BundleBuilder ([#1524](https://github.com/tcoratger/revm/pull/1524))
...
- *(EOF)* Add EOF to inspector handle register ([#1469](https://github.com/tcoratger/revm/pull/1469))
- *(optimism)* Implement new L1 cost function for Fjord ([#1420](https://github.com/tcoratger/revm/pull/1420))
- *(optimism)* Add secp256r1 precompile for Fjord ([#1436](https://github.com/tcoratger/revm/pull/1436))
- *(revm)* revert EIP-2935 BLOCKHASH opcode changes ([#1450](https://github.com/tcoratger/revm/pull/1450))
- load account should return db error ([#1447](https://github.com/tcoratger/revm/pull/1447))
- *(EOF)* remove TXCREATE ([#1415](https://github.com/tcoratger/revm/pull/1415))

### Fixed
- *(revm)* remove storage reset that clears is_cold flag ([#1518](https://github.com/tcoratger/revm/pull/1518))
- *(op)* Remove `U256::from(<float>)` ([#1498](https://github.com/tcoratger/revm/pull/1498))
...
- *(deps)* bump tokio from 1.37.0 to 1.38.0 ([#1480](https://github.com/tcoratger/revm/pull/1480))
- *(primitives)* rename State/Storage to EvmState/EvmStorage ([#1459](https://github.com/tcoratger/revm/pull/1459))
- remove 'checked' bytecode bench causing benchmarks to crash due to name ([#1461](https://github.com/tcoratger/revm/pull/1461))
- cargo update ([#1451](https://github.com/tcoratger/revm/pull/1451))
- cleanup host blockhash fn ([#1430](https://github.com/tcoratger/revm/pull/1430))
...
- *(deps)* bump anyhow from 1.0.82 to 1.0.83 ([#1404](https://github.com/tcoratger/revm/pull/1404))
